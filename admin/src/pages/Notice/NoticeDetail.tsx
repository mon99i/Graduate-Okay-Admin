  ...
  return (
    <div className="container mx-60 py-16">
      ...
      <div className="flex items-center mb-3">
        ...
        >
          <img src="/imgs/edit.png" alt="수정" className="w-4 h-4" />
        </button>
        <button onClick={handleDelete} className="rounded-md flex items-center">
          <img src="/imgs/delete.png" alt="삭제" className="w-4 h-4" />
        </button>
      </div>
